...
namespace Houses
{
    ...
    {
        public IEnumerable<Tuple<IPainter, double>> Organize(IEnumerable<IPainter> painters, double houses)
        {
        ...
        private IEnumerable<Tuple<IPainter, double>> Add(IEnumerable<Tuple<IPainter, double>> schedule, double part)
        {
        ...
        private IEnumerable<Tuple<IPainter, double>> CreateEmptySchedule(IEnumerable<IPainter> painters)
        {
            return
                painters
